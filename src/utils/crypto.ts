...
export class CryptoUtils {
   ...
   */
  static validatePemKey(key: string, type: 'PUBLIC KEY' | 'PRIVATE KEY' = 'PUBLIC KEY'): boolean {
    ...
    try {
      ...
      throw new Error(`Falha ao parsear ${type}: ${(e as Error).message}`);
    }
  }
   ...
   */
  static generateUniqueOrderNo(prefix: string = 'ORDER'): string {
