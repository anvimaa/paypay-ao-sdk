...
class PayPaySDK {
    ...
    async createBankAccountPayment({ outTradeNo, amount, bankCode, bankAccountNo, accountName, subject = "Bank Transfer", payerIp }) {
        // Validate required parameters
        if (!outTradeNo) throw new Error("outTradeNo is required");
        if (!amount) throw new Error("amount is required");
        if (!bankCode) throw new Error("bankCode is required");
        if (!bankAccountNo) throw new Error("bankAccountNo is required");
        ...
        const bizContent = {
            ...
            pay_method: {
                pay_product_code: "32", // Different product code for bank transfers
                amount: Number(amount).toFixed(2),
                bank_code: bankCode,
    ...
    async createPayPayAccountPayment({ outTradeNo, amount, payeeAccount, subject = "PAYPAY Transfer", payerIp, pay_product_code }) {
        // Validate required parameters
        if (!outTradeNo) throw new Error("outTradeNo is required");
        if (!amount) throw new Error("amount is required");
        if (!payeeAccount) throw new Error("payeeAccount is required");
        ...
        const bizContent = {
            ...
            pay_method: {
                pay_product_code, // Different product code for PAYPAY account transfers
                amount: Number(amount).toFixed(2),
